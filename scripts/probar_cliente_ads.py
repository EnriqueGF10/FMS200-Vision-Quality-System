...
resultado -> índice, aviso de trigger) de forma aislada, igual que los
algoritmos de visión se comprueban contra imágenes sin cámara.
...
def main():
    with patch.object(cliente_ads.pyads, "Connection", PLCFalsa):
        estacion = cliente_ads.ConexionEstacion(
            "FMS201", None, None, "GVL_FMS201", RESULTADOS_FMS201
        )
        estacion.conectar()
